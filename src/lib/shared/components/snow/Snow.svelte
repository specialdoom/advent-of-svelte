<script lang="ts">
	...
	let numberOfSnowflakes = $state(50);
	...
	let reduceMotionQuery: MediaQueryList | undefined = undefined;
	...
	function moveSnowflakes(currentTime: number) {
...
<div id="snowflakeContainer" bind:this={snowFlakeContainer}>
